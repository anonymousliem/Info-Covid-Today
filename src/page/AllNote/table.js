 ...
 // };
  ...
  render() {
   ...
   const currentresults = results.slice(indexOfFirstTodo, indexOfLastTodo);
    const renderresults = currentresults.map((results) => {
          ...
          {this.state.loading && (
            <Row>
              ...
              onChange={this.handleChange} /> */}
                    ...
                    <Table id="myTables" responsive striped>
                      <thead>
                        <tr id="halo">
                          <th onclick={this.sortTable}>	<Button className="btn btn-info" onClick={this.testAja} />  </th> 
                          <th >Username</th>
                          <th >Matkul</th>
                          <th >Description</th>
                          <th >Deadline</th>
